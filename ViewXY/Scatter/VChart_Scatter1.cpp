#include "VChart_Scatter1.h"

VChart_Scatter1::VChart_Scatter1(QWidget *parent) : VChart_Scatter(parent)
{

}

void VChart_Scatter1::paintGL()
{
    makeCurrent();
    ...
    {
        Channel_Scatter* tChannel = (Channel_Scatter*)m_Channels[chnli];
